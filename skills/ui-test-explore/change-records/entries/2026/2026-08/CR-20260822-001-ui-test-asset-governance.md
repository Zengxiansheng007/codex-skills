...
| Baseline | workspace-copy-first; current SKILL checksum sha256:f81a7e8d3af9bdbb2517ebf3a88a9bc41721c4ed86712550ddea26bc3e50afc6; global copy unchanged |
| Author | Codex |
| Related Records | ui-test/CR-20260822-007 |

## Summary

Link Midscene prompt rules and clarify private-page and R2 approval boundaries.
...
|---|---|---|
| `SKILL.md` and/or bundled resources | core-skill-md / references-and-assets / safety-and-governance | Link Midscene prompt rules and clarify private-page and R2 approval boundaries. |
