...
During this route, record one answer at a time in the Grill ledger and keep formal risk registers, their metadata, and substitute versions frozen. Do not save risk-policy changes until explicit whole-review closure makes centralized writeback eligible.
