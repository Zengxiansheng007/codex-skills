...
During this route, record one answer at a time in the Grill ledger and keep formal test artifacts, their metadata, RTM, and substitute versions frozen. Do not create or save test cases until explicit whole-review closure makes centralized writeback eligible.
