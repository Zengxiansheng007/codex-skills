...
Track changes to PRD authoring rules and workflow.

## Outline

| Date | Change ID | Section | Change Type | Summary | Status |
|---|---|---|---|---|---|
| 2026-09-06 | CR-20260906-003 | SKILL.md | governance | Freeze formal PRD artifacts during Grill and require closure-backed centralized writing. | validated |
