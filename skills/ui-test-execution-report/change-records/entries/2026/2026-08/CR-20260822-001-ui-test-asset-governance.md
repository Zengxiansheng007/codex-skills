...
|---|---|
| Status | validated |
| Target Skill | ui-test-execution-report |
...
| Baseline | workspace-copy-first; current SKILL checksum sha256:c46c922ae900e024a6ccd4825dd60841cddcdbe9d2f88be1cc83c9894bd0cc25; global copy unchanged |
| Author | Codex |
| Related Records | ui-test/CR-20260822-007 |

## Summary

Require canonical RunResult v2 and make reports read-only hash-preserving projections.
...
|---|---|---|
| `SKILL.md` and/or bundled resources | core-skill-md / references-and-assets / scripts-and-validation / safety-and-governance | Require canonical RunResult v2 and make reports read-only hash-preserving projections. |
