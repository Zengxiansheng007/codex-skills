...
| Baseline | workspace-copy-first; current SKILL checksum sha256:6b89154978ba7dc613d8be10b2357a4fdb797892d0505a045b0fe922f71b4add; global copy unchanged |
| Author | Codex |
| Related Records | ui-test/CR-20260822-007 |

## Summary

Link evidence taxonomy and make privacy and RunResult ownership explicit.
...
|---|---|---|
| `SKILL.md` and/or bundled resources | core-skill-md / references-and-assets / safety-and-governance | Link evidence taxonomy and make privacy and RunResult ownership explicit. |
