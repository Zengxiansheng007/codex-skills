...
| Baseline | workspace-copy-first; current SKILL checksum sha256:6d73755f7bba3f9024d7deb8d5f61a962651c86226c1a57700f729cd8e62fb3e; global copy unchanged |
| Author | Codex |
| Related Records | ui-test/CR-20260822-007 |

## Summary

Link planning checks and clarify that planning grants no execution authority.
...
|---|---|---|
| `SKILL.md` and/or bundled resources | core-skill-md / references-and-assets / safety-and-governance | Link planning checks and clarify that planning grants no execution authority. |
