...
| Baseline | workspace-copy-first; current SKILL checksum sha256:39a741c292a5755b9da3901200f384373f2d585bed35b862d5d74130f87da190; global copy unchanged |
| Author | Codex |
| Related Records | ui-test/CR-20260822-007 |

## Summary

Link locator policy and enforce current-run R2 approval before visible UI submit.
...
|---|---|---|
| `SKILL.md` and/or bundled resources | core-skill-md / references-and-assets / safety-and-governance | Link locator policy and enforce current-run R2 approval before visible UI submit. |
