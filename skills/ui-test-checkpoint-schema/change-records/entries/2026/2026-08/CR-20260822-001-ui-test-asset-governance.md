...
|---|---|
| Status | validated |
| Target Skill | ui-test-checkpoint-schema |
...
| Baseline | workspace-copy-first; current SKILL checksum sha256:12df6829efae0938c8d5be4347fa962c5b79586a16007f9e19df1012b0af78e6; global copy unchanged |
| Author | Codex |
| Related Records | ui-test/CR-20260822-007 |

## Summary

Clarify deterministic script references, validation and non-authorizing schema safety.
...
|---|---|---|
| `SKILL.md` and/or bundled resources | core-skill-md / scripts-and-validation / safety-and-governance | Clarify deterministic script references, validation and non-authorizing schema safety. |
